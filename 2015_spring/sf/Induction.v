...
Proof.
    intros n.
    simpl.
    rewrite plus_comm with (n := n) (m := 0).
    simpl.
    reflexivity.
Qed.
...
Proof.
    ...
    Case "p = S p".
        rewrite mult_comm.
        rewrite mult_comm with (m := n) (n := S p).
        rewrite mult_comm with (m := m) (n := S p).
        simpl.
        assert (forall (n m p : nat), n + m + p = n + p + m).
        SCase "Assert".
            intros.
            rewrite <- plus_assoc.
            rewrite plus_comm with (n := n0) (m := (m0 + p0)).
            rewrite plus_comm with (n := m0) (m := p0).
            rewrite <- plus_comm with (m := p0 + m0) (n := n0).
            rewrite plus_assoc.
            reflexivity.
        rewrite H.
        rewrite mult_comm in IHp.
        rewrite IHp.
        rewrite mult_comm.
        rewrite plus_assoc.
        (*assert (forall (n m p : nat), n + m + p = p + n + m).
        SCase "Assert".
            intros.
            rewrite plus_comm.
            rewrite plus_assoc.
        ...
        symmetry.
        rewrite plus_comm.
        rewrite <- plus_comm with (m := m) (n := p * m).
        rewrite mult_comm.
        rewrite plus_comm.
        rewrite plus_assoc.
        reflexivity.
