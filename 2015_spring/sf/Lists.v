...
Definition sum : bag -> bag -> bag := (fun (bag1 bag2 : bag) => (app bag1 bag2)).
...
Proof.
    ...
    Case "l = h :: t".
        simpl.
    assert (forall (l : natlist) (n : nat), rev (snoc l n) = n :: (rev l)).
        SCase "Assert".
        intros l n.
...
Proof.
    ...
    Case "l1 = h1 :: t1".
        ...
        rewrite snoc_append.
        rewrite IHt1.
        assert (rev l2 ++ snoc (rev t1) h1 = rev l2 ++ rev t1 ++ [h1]).
            rewrite snoc_append.
            reflexivity.
        rewrite H.
        rewrite app_assoc.
...
Proof.
    ...
    Case "s = h :: t".
        ...
        SCase "h = O".
            simpl.
            rewrite ble_n_Sn with (n := (count 0 t)).
            reflexivity.
        SCase "h = S h'".
            simpl.
            rewrite IHt.
