...
Proof.
    intros n.
    intros H0.
    induction H0 as [| n_3 | n_5 | n_sum m_sum].
    Case "b_0".
        apply g_0.
    Case "b_3".
        apply g_plus3.
...
Proof.
    ...
    rewrite <- plus_assoc.
    rewrite plus_comm.
    rewrite plus_comm with (n := x) (m := y).
    rewrite plus_comm.
    reflexivity.
Qed.
...
Proof.
    ...
    rewrite plus_comm.
    rewrite plus_assoc.
    assert (forall (a b c d : nat), (a + b) + (c + d) = a + b + c + d).
        intros.
        rewrite plus_assoc.
        reflexivity.
    rewrite <- H.
